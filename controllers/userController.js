...
const sendVerifyMail = async (name, email, user_id) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: '<p>Hyy ' + name + ', please click here to <a href="mongodb://127.0.0.1:3001/verify?id=' + user_id + ' "> Verify </a> your mail.</p>'
    }
...
const loginLoad = async (req, res) => {
  ...
  if (req.session.user_id) {
    ...
    console.log('Userr alredy logged');
  } else {
    try {
