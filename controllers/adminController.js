...
console.log(password,'password inside add ');
   try {
     ...
     const transporter = nodemailer.createTransport({
       ...
       requireTLS:true,
       auth:{
         user:'robinshaji888@gmail.com',
         pass:'uhuivzwdjlnuamyj'
     ...
     const mailOptions = {
         ...
         html:'<p>Hyy '+name+', please click here to <a href="  mongodb://127.0.0.1:3001/verify?id='+user_id+' "> Verify </a> your mail.</p> <br><br>  <b>Email:-</b>'+email+'<br><b>Password:-</b>'+password+''
     }
...
// add users in the new-user list
...
const addUser = async (req, res) => {
   ...
   //   const sec_password = await securePassword(password);
     ...
     if (userData) {
       addUserMail(name, email, passwordSample, userData._id.toString()); // Ensure userData._id is converted to a string
...
const updateUsers = async (req, res) => {
 ...
 const deleteUser = async(req,res)=>{
   ...
   try {
      ...
      console.log(error.message,'not valid string');
   }
 }  
